...
class VIJAGIF_WOO_FREE_GIFT_Admin_Admin {
	...
	public function admin_enqueue_scripts() {
		...
		if ( in_array( $current_screen, array(
			...
			wp_enqueue_script( 'select2', WC()->plugin_url() . '/assets/js/select2/select2.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'sortable', VIJAGIF_WOO_FREE_GIFT_JS . 'Sortable.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'transition', VIJAGIF_WOO_FREE_GIFT_JS . 'transition.min.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'dropdown', VIJAGIF_WOO_FREE_GIFT_JS . 'dropdown.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'checkbox', VIJAGIF_WOO_FREE_GIFT_JS . 'checkbox.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'accordion-semantic', VIJAGIF_WOO_FREE_GIFT_JS . 'accordion.min.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
		...
		if ( in_array( $current_screen, array( 'jagif_page_woo-free-gift-settings' ) ) ) {
			...
			wp_enqueue_script( 'transition', VIJAGIF_WOO_FREE_GIFT_JS . 'transition.min.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'dropdown', VIJAGIF_WOO_FREE_GIFT_JS . 'dropdown.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'address', VIJAGIF_WOO_FREE_GIFT_JS . 'address.min.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'tab', VIJAGIF_WOO_FREE_GIFT_JS . 'tab.js', array( 'jquery' ),VIJAGIF_WOO_FREE_GIFT_VERSION );

			wp_enqueue_script( 'jagif-admin-settings-js', VIJAGIF_WOO_FREE_GIFT_JS . 'jagif_admin_settings.' . $suffix . 'js', array( 'jquery' ) ,VIJAGIF_WOO_FREE_GIFT_VERSION );
		}
...
//			}
			...
			wp_enqueue_script( 'jagif-admin-rule', VIJAGIF_WOO_FREE_GIFT_JS . 'jagif_admin_rule.' . $suffix . 'js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );

			wp_enqueue_script( 'dropdown', VIJAGIF_WOO_FREE_GIFT_JS . 'dropdown.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'transition', VIJAGIF_WOO_FREE_GIFT_JS . 'transition.min.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'select2', WC()->plugin_url() . '/assets/js/select2/select2.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'select2-full', WC()->plugin_url() . '/assets/js/select2/select2.full.min.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'checkbox', VIJAGIF_WOO_FREE_GIFT_JS . 'checkbox.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
			wp_enqueue_script( 'accordion-semantic', VIJAGIF_WOO_FREE_GIFT_JS . 'accordion.min.js', array( 'jquery' ), VIJAGIF_WOO_FREE_GIFT_VERSION );
