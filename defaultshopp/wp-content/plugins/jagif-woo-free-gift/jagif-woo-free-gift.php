 ...
 * Description: <strong>Jagif - WooCommerce Free Gift</strong> allows creating gift pack and giving them according to the rules you create when customers buy products.
 * Version: 1.1.2
 * Author: VillaTheme
...
define( 'VIJAGIF_WOO_FREE_GIFT_VERSION', '1.1.2' );
