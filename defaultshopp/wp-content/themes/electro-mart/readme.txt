...
Tags:blog,e-commerce,two-columns,right-sidebar,full-width-template,custom-colors,custom-menu,
...
= 2.0 =
* HTML5 Support Added Properly
* Minor CSS changes in style.css file
...
Source: https://www.maxpixel.net/Music-Headphones-Cropping-Sony-Isolated-Stereo-2919314 (slider image)
