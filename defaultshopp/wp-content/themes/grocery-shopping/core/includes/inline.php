...
$grocery_shopping_pagination_setting = get_theme_mod('grocery_shopping_pagination_setting',true);
	...
	if($grocery_shopping_slider_opacity_color == '0'){
		...
		}else if($grocery_shopping_slider_opacity_color == '1.0'){
	...
	$grocery_shopping_overlay_option = get_theme_mod('grocery_shopping_overlay_option', true);

	if($grocery_shopping_overlay_option == false){
	...
	$grocery_shopping_slider_image_overlay_color = get_theme_mod('grocery_shopping_slider_image_overlay_color', true);

	if($grocery_shopping_slider_image_overlay_color != false){

		$grocery_shopping_custom_css .='.blog_inner_box{';

			$grocery_shopping_custom_css .='background-color: '.esc_attr($grocery_shopping_slider_image_overlay_color).';';
