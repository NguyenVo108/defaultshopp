...
?>
        <style type="text/css">
            ...
            .entry-content h1 {
                font-size: <?php echo esc_attr(get_theme_mod('honrix_h1_font_size', '36')); ?>px;
            }

            .entry-content h2 {
                font-size: <?php echo esc_attr(get_theme_mod('honrix_h2_font_size', '32')); ?>px;
            }

            .entry-content h3 {
                font-size: <?php echo esc_attr(get_theme_mod('honrix_h3_font_size', '28')); ?>px;
            }

            .entry-content h4 {
                font-size: <?php echo esc_attr(get_theme_mod('honrix_h4_font_size', '25')); ?>px;
            }

            .entry-content h5 {
                font-size: <?php echo esc_attr(get_theme_mod('honrix_h5_font_size', '21')); ?>px;
            }

            .entry-content h6 {
                font-size: <?php echo esc_attr(get_theme_mod('honrix_h6_font_size', '17')); ?>px;
            }
        </style>
<?php
    }
