                ...
                <div class="honrix-getting-started-notice clearfix">
                    ...
                    <div class="honrix-theme-notice-content">
                        ...
                        /* translators: 1: welcome page link starting html tag, 2: welcome page link ending html tag. */
                            esc_html__( 'Welcome! Thank you for choosing %1$s!', 'honrix' ), '<strong>'. wp_get_theme()->get('Name'). '</strong>' );
                        ?>
                        </h2>

                        <a class="honrix-btn-get-started button button-primary button-hero honrix-button-padding" href="<?php echo esc_url(admin_url("admin.php?page=honrix_welcome")); ?>" data-name="" data-slug=""><?php esc_html_e( 'Get started with Honrix', 'honrix' ) ?></a><span class="honrix-push-down">
                        <?php
