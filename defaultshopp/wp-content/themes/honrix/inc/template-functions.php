...
if (!function_exists('honrix_logo')) {
    function honrix_logo()
    {
        ...
        if ($honrix_description) : ?>
            <p class="site-description"><?php echo esc_html($honrix_description); ?></p>
        <?php endif;
    }
    ...
    function honrix_header_account()
    {
        if (class_exists('woocommerce')) : ?>
            ...
            <div class="hrix-header-account honrix-is-pc w40px d-flex align-items-center justify-content-center">
                <a href="<?php echo esc_url(get_permalink(get_option('woocommerce_myaccount_page_id'))); ?>" title="<?php echo is_user_logged_in() ? esc_html(wp_get_current_user()->display_name) : __('Login', 'honrix'); ?>" class="d-flex align-items-center justify-content-end">
            ...
            <div class="fs-4 w40px d-flex align-items-center justify-content-center honrix-is-pc">
                <span class="hrix-header-wishlist position-relative">
                    <a href="<?php echo esc_url($wishlist_url); ?>" data-tooltip="<?php esc_attr_e('Wishlist', 'honrix'); ?>" title="<?php esc_attr_e('Wishlist', 'honrix'); ?>">
                        ...
                        <?php if (intval(yith_wcwl_count_all_products()) > 0) : ?>
...
if (!function_exists('honrix_browse_cat')) {
    ...
    {
        $browse_cat_ttl        = get_theme_mod('browse_cat_ttl', '<i class="fas fa-bars me-2"></i> Browse Categories');
