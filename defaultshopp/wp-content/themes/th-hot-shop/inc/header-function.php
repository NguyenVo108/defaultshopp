<?php 
/**
 * Header Function for Th Hot Shoptheme.
 * 
 * @package     Open Shop
 * @author      ThemeHunk
...
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('open_shop_col1_texthtml',  __( 'Add your content here', 'th-hot-shop' )));?>
</div>
...
<a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>"><?php esc_html_e( 'Assign Above header menu', 'th-hot-shop' );?></a>
 <?php }
  ...
  <div class="content-widget">
    ...
    dynamic_sidebar('top-header-widget-col1' );
      ...
      <a href="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>"><?php esc_html_e( 'Add Widget', 'th-hot-shop' );?></a>
     <?php }?>
     </div>
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('open_shop_col2_texthtml',  __( 'Add your content here', 'th-hot-shop' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('open-shop-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('open_shop_col3_texthtml',  __( 'Add your content here', 'th-hot-shop' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('open-shop-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
$open_shop_menu_open = get_theme_mod('open_shop_mobile_menu_open','left');
$main_header_layout = get_theme_mod('open_shop_main_header_layout','mhdrdefault');
?> 
            ...
            <div class="menu-category-list">
              <div class="toggle-cat-wrap">
                  <p class="cat-toggle">
                    ...
                    <span class="toggle-title"><?php _e('Category','th-hot-shop');?></span>
...
function open_shop_main_header_optn(){
          ...
          <a href="<?php echo esc_url(get_theme_mod('open_shop_main_hdr_btn_lnk','#')); ?>" class="btn-main-header"><?php echo esc_html(get_theme_mod('open_shop_main_hdr_btn_txt', __('Button Text','th-hot-shop'))); ?></a>
          <?php }
          ...
          <div class="header-support-wrap">
              ...
              <div class="header-support-content">
                <span class="sprt-tel"><b><?php echo esc_html(get_theme_mod('open_shop_main_hdr_calto_txt',__('Call To','th-hot-shop'))); ?></b> <a href="tel:<?php echo esc_attr(get_theme_mod('open_shop_main_hdr_calto_nub',__('+1800090098','th-hot-shop'))); ?>"><?php echo esc_html(get_theme_mod('open_shop_main_hdr_calto_nub',__('+1800090098','th-hot-shop'))); ?></a></span>
                <span class="sprt-eml"><?php _e('Email :','th-hot-shop');?> <a href="mailto:<?php echo esc_attr(get_theme_mod('open_shop_main_hdr_calto_email',__('Info@gmail.com','th-hot-shop'))); ?>"><?php echo esc_html(get_theme_mod('open_shop_main_hdr_calto_email',__('Info@gmail.com','th-hot-shop'))); ?></a></span>
              </div>
          </div>
...
function open_shop_th_advance_product_search(){
              ...
              if ( shortcode_exists('th-aps') ){
                ...
                <a target="_blank" class="plugin-active-msg" href="<?php echo esc_url($url);?>">
                  ...
                  <?php _e('Please Install "th advance product search" Plugin','th-hot-shop');?>
